...
bool MainGameUpdate( float elapsedTime )
{
	...
	UpdateLasers();
	UpdateDestroyed();
	Play::DrawFontText("64px", "ARROW KEYS TO MOVE UP, DOWN, LEFT AND RIGHT, AND SPACE TO FIRE",
...
void HandlePlayerControls()
{
	...
	Play::StopAudioLoop("pause");
	Play::UpdateGameObject(obj_agent8);

	if (Play::KeyPressed(VK_F4)) 
	{
		Play::StopAudioLoop("musicok");
		Play::StopAudioLoop("pause");
	}
